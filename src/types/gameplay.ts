...
// @FIX: Add Shop and ShopItem types to resolve module errors.
export interface ShopItem extends Omit<InventoryItem, 'id' | 'isEquipped' | 'quantity'> {
    price: { currencyName: CurrencyType; amount: number; };
