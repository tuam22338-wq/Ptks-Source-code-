...
export const WORLD_MAP: Location[] = [
    ...
    { id: 'trieu_ca', name: 'Triều Ca', description: 'Kinh đô của nhà Thương, phồn hoa và tráng lệ, nhưng ẩn chứa nhiều âm mưu và nguy hiểm.', type: 'Thành Thị', neighbors: ['song_vi_thuy', 'tam_son_quan', 'loc_dai', 'ky_chau', 'thanh_khau_quoc', 'cuu_le_thon', 'hien_vien_mo'], coordinates: { x: 12, y: 5 }, qiConcentration: 2, shopIds: ['van_bao_lau'] },
