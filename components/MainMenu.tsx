  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center animate-fade-in-menu">
        <div className="text-center">
            <h1 className="text-6xl sm:text-7xl font-bold font-title animate-menu-item" style={{color: 'var(--text-color)', textShadow: '0 2px 5px rgba(0,0,0,0.5)', animationDelay: '100ms'}}>
                Phong Thần Ký Sự
            </h1>
            <h2 className="text-2xl sm:text-3xl mt-2 tracking-widest font-semibold font-title animate-menu-item" style={{color: 'var(--text-muted-color)', animationDelay: '300ms'}}>
                Khởi Nguyên
            </h2>
        </div>
